 ...
 */
public class WelcomePagerAdapter extends BenihPagerAdapter<WelcomeFragment> {
    public WelcomePagerAdapter(FragmentManager fm, List<WelcomeFragment> welcomeFragments) {
        super(fm, welcomeFragments);
    }
