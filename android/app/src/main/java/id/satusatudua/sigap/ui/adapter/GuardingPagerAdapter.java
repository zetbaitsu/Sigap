 ...
 */
public class GuardingPagerAdapter extends BenihPagerAdapter<BenihFragment> {

    public GuardingPagerAdapter(FragmentManager fm, List<BenihFragment> benihFragments) {
