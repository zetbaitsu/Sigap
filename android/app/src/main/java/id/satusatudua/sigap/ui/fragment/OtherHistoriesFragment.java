 ...
 */
public class OtherHistoriesFragment extends BenihFragment implements HistoriesPresenter.View,
    ...
    public static OtherHistoriesFragment newInstance(User user) {
        OtherHistoriesFragment fragment = new OtherHistoriesFragment();
    ...
    protected void onViewReady(@Nullable Bundle savedInstanceState) {
        ...
        adapter = new HistoryAdapter(getActivity(), user);
        recyclerView.setAdapter(adapter);
        recyclerView.setUpAsList();

        presenter = new HistoriesPresenter(this, user);
