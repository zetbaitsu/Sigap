...
import id.satusatudua.sigap.ui.adapter.viewholder.MyContactViewHolder;
 ...
 */
public class MyContactAdapter extends BenihRecyclerAdapter<ImportantContact, MyContactViewHolder> {
    ...
    public MyContactViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new MyContactViewHolder(getView(parent, viewType), itemClickListener, longItemClickListener);
    }
}
