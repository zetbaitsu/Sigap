 ...
 */
public class CaseReviewViewHolder extends BenihItemViewHolder<CaseReview> {

    @Bind(R.id.name) TextView name;
    @Bind(R.id.status) TextView status;
    @Bind(R.id.review) TextView review;

    public CaseReviewViewHolder(View itemView, OnItemClickListener itemClickListener, OnLongItemClickListener longItemClickListener) {
        super(itemView, itemClickListener, longItemClickListener);
    }

    @Override
    public void bind(CaseReview caseReview) {
        name.setText(caseReview.getUser().getName());
        status.setText(caseReview.getStatus());
        review.setText(caseReview.getReview());
    }
}
