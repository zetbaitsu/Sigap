...
import id.satusatudua.sigap.presenter.UpdatePasswordPresenter;
 ...
 */
public class UpdatePasswordActivity extends BenihActivity implements SetPasswordPresenter.View,
    ...
    public void save() {
        ...
        if (pass1.isEmpty()) {
            ...
            presenter.updatePassword(pass1);
        }
    }
    ...
    public void onPasswordUpdated(User currentUser) {
        new AlertDialog.Builder(this)
                ...
                .setCancelable(false)
                .setMessage("Kata sandi anda berhasil diubah!")
