 ...
 */
public class GuardCandidateViewHolder extends BenihItemViewHolder<GuardCandidate> {

    @Bind(R.id.tv_name) TextView name;
    @Bind(R.id.tv_email) TextView email;
    @Bind(R.id.button_checked) ImageView buttonChecked;

    public GuardCandidateViewHolder(View itemView, OnItemClickListener itemClickListener, OnLongItemClickListener longItemClickListener) {
    ...
    public void bind(GuardCandidate guardCandidate) {
        ...
        email.setText(guardCandidate.getUser().getEmail());
        buttonChecked.setVisibility(guardCandidate.isSelected() ? View.VISIBLE : View.GONE);
    }
}
